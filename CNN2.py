...
if __name__ == '__main__':
    ...
    file_x1 = "./data/features_train_aug.dat"
    file_y1 = './data/label_class_0_train_aug.dat'
    file_x2 = "./data/features_test_aug.dat"
    file_y2 = './data/label_class_0_test_aug.dat'
    ...
    X_train = X_train.reshape(-1, 1, 40, 14)
    print(X_train.shape)
    ...
    X_test = X_test.reshape(-1, 1, 40, 14)
