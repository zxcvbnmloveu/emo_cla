...
def cross_validate0(X, file_y, feaselect = False):
...
def fisher_idx(features, labels):
    ...
    if(features[:,feature_idx].shape[2] < 3):
        print(features[:,sorted_feature_idx].shape)
...
def run_fea(file_x, feaselect = False):
    ...
    print("valence")
    cross_validate0(file_x, file_y1, feaselect = feaselect)
    print("Arousal")
    cross_validate0(file_x, file_y2, feaselect = feaselect)
